...
import com.zhihu.matisse.internal.utils.*;
import java.util.*;
...
public enum MimeType {
    ...
    public static Set<MimeType> ofVideo() {
        return EnumSet.of(MPEG, MP4, QUICKTIME, THREEGPP, MKV);
    }
    ...
    private static Set<String> arraySetOf(String s1) {
		Set<String> l = new ArraySet<>();
		l.add(s1);
        return l;
    }
	
	private static Set<String> arraySetOf(String s1, String s2) {
		Set<String> l = new ArraySet<>();
		l.add(s1);
		l.add(s2);
        return l;
